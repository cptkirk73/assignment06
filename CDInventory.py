...
# Change Log: (akirkland- updated code added in new functions and orginazation)
# Andrew Kirkland, 2021-Feb-21, Created File
#------------------------------------------#
...
class FileProcessor:
    ...
    def write_file(file_name, table):
        # Appending to CDInventory.txt if the user decides they want to
        if strChoice == 's':
